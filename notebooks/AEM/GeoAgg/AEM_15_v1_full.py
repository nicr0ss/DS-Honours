...
with open("AEM_15_model_v1_full.pkl", "wb") as f:
    pickle.dump(model, f)
...
tests["pred"] = y_pred
tests.to_csv("full_train_v1.csv")

print(f'R-sq = {r2_score(y_true=y[tab_y], y_pred=y)}')
print(f'MAE = {mean_absolute_error(y_true=y[tab_y], y_pred=y_pred)}')